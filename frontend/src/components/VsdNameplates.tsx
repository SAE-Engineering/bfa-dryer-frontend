...
// Node address update 2026-06-10: Spinner readdressed to Modbus slave 5 (addr 1 is
// invisible on Teco drives). Live map: ag1=2, ag2=3, trace=4, spinner=5.
interface Plate {
...
const PLATES: Plate[] = [
  { node: 5, name: 'Spinner',     volts: '420 / 440', hz: '50 / 60', rpm: '964 / 1157',  kw: '3.0',  amps: '7.02 / 6.66', cos: '0.74 / 0.78', conn: 'Y (star)',  poles: '6', eff: '83.3 / 83.6 / 82.3' },
  ...
  { node: 4, name: 'Trace Chain', volts: '230',        hz: '50',      rpm: '850',          kw: '0.09', amps: '0.85',        cos: '0.67',        conn: 'Δ (delta)', poles: '—', eff: '39.6' },
]
      ...
      >
        ...
        <div className="px-5 py-4">
          <p className="mb-3 text-xs text-gray-400">
            ...
            60 Hz figures are the alternate rating. Live Modbus addresses: Ag1=2, Ag2=3, Trace=4, Spinner=5
            (addr 1 reserved — invisible on Teco drives).
          </p>
          ...
          <p className="mt-4 rounded-md border border-amber-700/50 bg-amber-900/20 px-3 py-2 text-xs text-amber-300">
            ...
            unit (or motor rewired star for 400 V supply) before commissioning node 4.
          </p>
        </div>
      </div>
    </div>
